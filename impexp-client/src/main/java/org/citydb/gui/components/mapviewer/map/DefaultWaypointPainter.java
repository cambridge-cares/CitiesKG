...
public class DefaultWaypointPainter implements Painter<JXMapViewer> {
	...
	private final class SingleWaypointRenderer implements WaypointRenderer {
		...
		public SingleWaypointRenderer() {
			try {
				precise = ImageIO.read(getClass().getResource(
            "/org/citydb/gui/images/map/waypoint_precise.png"));
				approximate = ImageIO.read(getClass().getResource(
            "/org/citydb/gui/images/map/waypoint_approximate.png"));
				reverse = ImageIO.read(getClass().getResource(
            "/org/citydb/gui/images/map/waypoint_reverse.png"));
			} catch (Exception ex) {
