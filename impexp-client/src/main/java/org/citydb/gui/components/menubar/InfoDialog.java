	...
	private void initGUI() {
		...
		{			
			...
			header.setLayout(new GridBagLayout());
			{
				...
				JLabel img = new JLabel(new ImageIcon(getToolkit().getImage(this.getClass().getResource(
            "/org/citydb/gui/images/common/logo.png"))));
	...
	private JPanel getPartnerTab() {
		...
		partner.setLayout(new GridBagLayout());
		{
			...
			logos.setLayout(new GridBagLayout());
			{
				...
				JLabel tum_logo = new JLabel(new ImageIcon(getToolkit().getImage(this.getClass().getResource(
            "/org/citydb/gui/images/partner/tum_logo.png"))));
				...
				JLabel vcs_logo = new JLabel(new ImageIcon(getToolkit().getImage(this.getClass().getResource(
            "/org/citydb/gui/images/partner/vcs_logo.png"))));
				...
				JLabel moss_logo = new JLabel(new ImageIcon(getToolkit().getImage(this.getClass().getResource(
            "/org/citydb/gui/images/partner/moss_logo.png"))));
