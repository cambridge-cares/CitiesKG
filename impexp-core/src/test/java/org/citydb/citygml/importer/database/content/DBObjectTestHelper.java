...
public class DBObjectTestHelper {
    ...
    public static CityGMLBuilder getCityGMLBuilder(){
    ...
    public static AbstractDatabaseAdapter getAbstractDatabaseAdapter(){
        return new AbstractDatabaseAdapter() {
            @Override
    ...
    public static CityGMLImportManager getCityGMLImportManager(){
        ...
        WorkerPool<DBXlink> dbXlinkWorkerPool = null;
        UIDCacheManager uidCacheManager = new UIDCacheManager();
        
        
        
        return new CityGMLImportManager(inputFile, connection, abstractDatabaseAdapter, schemaMapping, cityGMLBuilder, dbXlinkWorkerPool, uidCacheManager);
    }
}