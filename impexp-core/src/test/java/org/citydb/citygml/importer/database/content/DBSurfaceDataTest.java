...
class DBSurfaceDataTest {
    ...
    void getSPARQLStatementTest() throws Exception {
        ...
        String expected = "PREFIX ocgml: <http://locahost/ontocitygml/> BASE <http://localhost/berlin/> INSERT DATA { GRAPH <surfacedata/> { ? ocgml:id  ?;ocgml:gmlId  ?;ocgml:name  ?;ocgml:nameCodespace  ?;ocgml:description  ?;ocgml:isFront  ?;ocgml:objectClassId  ?;";
        String generated = "";  //
