...
public class DBTunnelInstallation extends AbstractDBImporter {
	...
	protected String getSQLStatement() {
		return "insert into " + SQL_SCHEMA + ".tunnel_installation (id, objectclass_id, class, class_codespace, function, function_codespace, usage, usage_codespace, tunnel_id, tunnel_hollow_space_id, " +
