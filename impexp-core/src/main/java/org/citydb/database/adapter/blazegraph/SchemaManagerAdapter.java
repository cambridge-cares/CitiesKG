...
public class SchemaManagerAdapter extends AbstractSchemaManagerAdapter {
    ...
    public static final String ONTO_SRID = ONTO_PREFIX_NAME_ONTOCITYGML + "srid"; //has not been added to ontoCityGML
    public static final String ONTO_SRTEXT = ONTO_PREFIX_NAME_ONTOCITYGML + "srtext"; //has not been added to ontoCityGML
