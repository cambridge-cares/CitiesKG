...
public class BlazegraphConfig {
  ...
  /**
   * Constructor - builds config in the required format.
   *
  ...
  public BlazegraphConfig(Set<String> geoDataTypes) {
    ...
    config.setProperty("com.bigdata.rdf.store.AbstractTripleStore.axiomsClass",
        "com.bigdata.rdf.axioms.NoAxioms");
    config.setProperty("com.bigdata.rdf.store.AbstractTripleStore.vocabularyClass",
    ...
    config.setProperty("com.bigdata.namespace.wdq.lex.com.bigdata.btree.BTree.branchingFactor",
        "800");
    config.setProperty(
    ...
    config.setProperty("com.bigdata.namespace.wdq.spo.com.bigdata.btree.BTree.branchingFactor",
        "2048");
    config.setProperty("com.bigdata.namespace.wdq.spo.OSP.com.bigdata.btree.BTree.branchingFactor",
        "128");
    config.setProperty("com.bigdata.namespace.wdq.spo.SPO.com.bigdata.btree.BTree.branchingFactor",
        "1200");
    ...
    config
        .setProperty("com.bigdata.rdf.store.AbstractTripleStore.geoSpatialIncludeBuiltinDatatypes",
            "true");
