...
echo "Step 0: Spin up the container, which execute the docker-compose.yml"
...
#echo "Step 1: Initalize Access Agent by execute the upload the routing file in access_agent_setup directory"
sleep 5
...
#echo "Decompress the file and copy to 3dwebclient"
#tar -xvf singaporeEPSG4326.tar.gz -C ./3dwebclient

# Step 3: start the batch for blazegraph
echo "Step 3: start the batch for blazegraph"
cd D:/blazegraphDB/blazegraph
#start "cmd.exe" /c Start_Blazegraph_with_default_settings.bat
