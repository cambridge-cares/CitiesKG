...
public class CityInformationAgentTest {
    ...
    public void testProcessRequestParameters() {
        ...
        // TODO: Test case when agent successfully sends request to another agent
        // Issue - Some method declared in Http class in jps-base-lib uses variable arguments (for e.g. "Object..." argument) which are handled differently by Mockito in java 11 as compared with Java 8.
        // This needs to be updated in jps-base-lib
    }
