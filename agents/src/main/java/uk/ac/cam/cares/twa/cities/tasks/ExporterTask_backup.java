...
public class ExporterTask_backup implements Runnable {
    ...
    public ExporterTask_backup(String[] gmlIds, String outputPath, JSONObject serverInfo, String[] displayMode) {
        this.inputs = gmlIds;
